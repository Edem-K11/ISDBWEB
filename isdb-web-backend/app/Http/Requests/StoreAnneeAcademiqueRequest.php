...
class StoreAnneeAcademiqueRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            // Log pour années passées (non bloquant)
            $currentYear = now()->year;
            if ($this->annee_debut < $currentYear) {
                Log::info("Création d'une année académique antérieure : {$this->annee_debut}-{$this->annee_fin}");
            }
        });
    }
