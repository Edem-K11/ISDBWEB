...
export default function DiscoverCard({ title, theme, link }: DiscoverCardProps) {
  ...
  return (
    <Link href={link}>
      <div
        className={cn(
          'relative overflow-hidden rounded-lg h-40 flex items-center justify-between cursor-pointer transition-all duration-300 group bg-gradient-to-r',
          colors.tileGradient
        )}
