...
// app/dashboard/formations/create/modulaire/page.tsx
'use client';
...
import type { Diplome, StatutFormation, TypeFormation } from '@/lib/types/Formation';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-isdb-green-800 focus:border-transparent ${
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-isdb-green-800 focus:border-transparent resize-none"
              maxLength={300}
            />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-isdb-green-800 focus:border-transparent ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-isdb-green-800 focus:border-transparent"
                />
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-end gap-4">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-6 py-3 bg-isdb-green-800 text-white rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center gap-2 min-w-[180px]"
            >
              {isSubmitting ? (
                <>
